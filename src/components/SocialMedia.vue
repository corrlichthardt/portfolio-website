<template>
  <div class="media-wrapper">
    <li class="media-list">
      <a
        href="https://www.facebook.com/theartofcorr/"
    ...
    <li class="media-list">
      <a
        href="https://www.instagram.com/corri_li/"
        class="icon-15 instagram"
        title="Instagram"
        id="media"
        target="_blank"
      >
    ...
    <li class="media-list">
      <a
        href="https://github.com/corrlichthardt"
    ...
    <li class="media-list">
      <a
        href="https://www.linkedin.com/in/corrina-lichthardt-74a150b8/"
